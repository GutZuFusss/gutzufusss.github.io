...
re_frame.core.reg_sub.cljs$core$IFn$_invoke$arity$variadic(new cljs.core.Keyword("openllm.components.chat.subs","prompt","openllm.components.chat.subs/prompt",-885374803),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"<-","<-",760412998),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("openllm.components.chat.subs","prompt-layout","openllm.components.chat.subs/prompt-layout",-1833402282)], null),new cljs.core.Keyword(null,"<-","<-",760412998),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("openllm.components.chat.subs","chat-input-value","openllm.components.chat.subs/chat-input-value",-1630109332)], null),new cljs.core.Keyword(null,"<-","<-",760412998),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("openllm.components.chat.subs","chat-history","openllm.components.chat.subs/chat-history",-1501250194)], null),(function (p__39168,_){
var vec__39169 = p__39168;
var prompt_layout = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39169,(0),null);
var chat_input_value = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39169,(1),null);
var chat_history = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39169,(2),null);
