...
var on_change = (function (p1__30688_SHARP_){
return re_frame.core.dispatch(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("openllm.components.chat.events","set-chat-input-value","openllm.components.chat.events/set-chat-input-value",990254050),p1__30688_SHARP_.target.value], null));
});
return (function (){
 ...
 */
openllm.components.chat.views.chat_message_entry = (function openllm$components$chat$views$chat_message_entry(p__30689){
var map__30690 = p__30689;
var map__30690__$1 = cljs.core.__destructure_map(map__30690);
var user = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30690__$1,new cljs.core.Keyword(null,"user","user",1532431356));
var text = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30690__$1,new cljs.core.Keyword(null,"text","text",-1790561697));
...
var on_change = (function (p1__30691_SHARP_){
return re_frame.core.dispatch(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("openllm.components.chat.events","set-prompt-layout","openllm.components.chat.events/set-prompt-layout",-1573538316),p1__30691_SHARP_.target.value], null));
});
return (function (){
