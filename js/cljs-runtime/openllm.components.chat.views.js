...
var on_change = (function (p1__28705_SHARP_){
return re_frame.core.dispatch(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("openllm.components.chat.events","set-chat-input-value","openllm.components.chat.events/set-chat-input-value",990254050),p1__28705_SHARP_.target.value], null));
});
return (function (){
 ...
 */
openllm.components.chat.views.chat_message_entry = (function openllm$components$chat$views$chat_message_entry(p__28706){
var map__28707 = p__28706;
var map__28707__$1 = cljs.core.__destructure_map(map__28707);
var user = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28707__$1,new cljs.core.Keyword(null,"user","user",1532431356));
var text = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28707__$1,new cljs.core.Keyword(null,"text","text",-1790561697));
...
var on_change = (function (p1__28708_SHARP_){
return re_frame.core.dispatch(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("openllm.components.chat.events","set-prompt-layout","openllm.components.chat.events/set-prompt-layout",-1573538316),p1__28708_SHARP_.target.value], null));
});
return (function (){
