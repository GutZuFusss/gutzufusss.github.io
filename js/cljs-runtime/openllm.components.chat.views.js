...
var on_change = (function (p1__29217_SHARP_){
return re_frame.core.dispatch(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("openllm.components.chat.events","set-chat-input-value","openllm.components.chat.events/set-chat-input-value",990254050),p1__29217_SHARP_.target.value], null));
});
return (function (){
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"textarea","textarea",-650375824),new cljs.core.PersistentArrayMap(null, 7, [new cljs.core.Keyword(null,"class","class",-2030961996),"py-1 h-10 w-[calc(100%_-_195px)] block self-end",new cljs.core.Keyword(null,"style","style",-496642736),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"resize","resize",297367086),"none"], null),new cljs.core.Keyword(null,"placeholder","placeholder",-104873083),"Type your message...",new cljs.core.Keyword(null,"value","value",305978217),cljs.core.deref(chat_input_sub),new cljs.core.Keyword(null,"on-change","on-change",-732046149),on_change,new cljs.core.Keyword(null,"on-key-press","on-key-press",-399563677),(function (e){
 ...
 */
openllm.components.chat.views.chat_message_entry = (function openllm$components$chat$views$chat_message_entry(p__29218){
var map__29219 = p__29218;
var map__29219__$1 = cljs.core.__destructure_map(map__29219);
var user = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29219__$1,new cljs.core.Keyword(null,"user","user",1532431356));
var text = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29219__$1,new cljs.core.Keyword(null,"text","text",-1790561697));
...
var on_change = (function (p1__29220_SHARP_){
return re_frame.core.dispatch(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("openllm.components.chat.events","set-prompt-layout","openllm.components.chat.events/set-prompt-layout",-1573538316),p1__29220_SHARP_.target.value], null));
});
return (function (){
