...
var G__37794 = o;
reagent.impl.template.goog$module$goog$object.set(G__37794,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
return (function() { 
var G__37812__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
var G__37812 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__37813__i = 0, G__37813__a = new Array(arguments.length -  0);
while (G__37813__i < G__37813__a.length) {G__37813__a[G__37813__i] = arguments[G__37813__i + 0]; ++G__37813__i;}
  args = new cljs.core.IndexedSeq(G__37813__a,0,null);
} 
return G__37812__delegate.call(this,args);};
G__37812.cljs$lang$maxFixedArity = 0;
G__37812.cljs$lang$applyTo = (function (arglist__37814){
var args = cljs.core.seq(arglist__37814);
return G__37812__delegate(args);
});
...
var G__37795 = o;
reagent.impl.template.goog$module$goog$object.set(G__37795,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
if(cljs.core.ifn_QMARK_(x)){
return (function() { 
var G__37815__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
var G__37815 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__37816__i = 0, G__37816__a = new Array(arguments.length -  0);
while (G__37816__i < G__37816__a.length) {G__37816__a[G__37816__i] = arguments[G__37816__i + 0]; ++G__37816__i;}
  args = new cljs.core.IndexedSeq(G__37816__a,0,null);
} 
return G__37815__delegate.call(this,args);};
G__37815.cljs$lang$maxFixedArity = 0;
G__37815.cljs$lang$applyTo = (function (arglist__37817){
var args = cljs.core.seq(arglist__37817);
return G__37815__delegate(args);
});
G__37815.cljs$core$IFn$_invoke$arity$variadic = G__37815__delegate;
return G__37815;
})()
;
} else {
...
var G__37796 = props;
var G__37796__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__37796,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__37796);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__37796__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__5045__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__37797 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__37797,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__37797;
}
})(),id_class);
...
var G__37798 = (cljs.core.count(argv) - first_child);
switch (G__37798) {
case (0):
...
var vec__37799 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37799,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37799,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37799,(2),null);
...
var temp__5808__auto___37819 = reagent.impl.util.react_key_from_vec(v);
if((temp__5808__auto___37819 == null)){
} else {
var key_37820 = temp__5808__auto___37819;
(jsprops.key = key_37820);
}
...
var temp__5808__auto___37821 = reagent.impl.util.react_key_from_vec(v);
if((temp__5808__auto___37821 == null)){
} else {
var key_37822 = temp__5808__auto___37821;
(jsprops.key = key_37822);
}
...
var temp__5808__auto___37823 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5808__auto___37823 == null)){
} else {
var key_37824 = temp__5808__auto___37823;
(jsprops.key = key_37824);
}
...
var temp__5808__auto___37831 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5808__auto___37831 == null)){
} else {
var key_37832 = temp__5808__auto___37831;
(jsprops.key = key_37832);
}
...
var temp__5808__auto___37833 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5808__auto___37833 == null)){
} else {
var key_37835 = temp__5808__auto___37833;
(jsprops.key = key_37835);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__37802_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__37802_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__37803 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37803,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37803,(1),null);
...
break;
default:
var G__37841 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__37842 = compiler;
v = G__37841;
compiler = G__37842;
continue;
...
*/
reagent.impl.template.t_reagent$impl$template37809 = (function (opts,id,fn_to_element,parse_fn,meta37810){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template37809.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_37811,meta37810__$1){
var self__ = this;
var _37811__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template37809(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta37810__$1));
}));

(reagent.impl.template.t_reagent$impl$template37809.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_37811){
var self__ = this;
var _37811__$1 = this;
return self__.meta37810;
}));

(reagent.impl.template.t_reagent$impl$template37809.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template37809.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template37809.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
...
(reagent.impl.template.t_reagent$impl$template37809.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template37809.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template37809.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta37810","meta37810",607389715,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template37809.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template37809.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template37809");

(reagent.impl.template.t_reagent$impl$template37809.cljs$lang$ctorPrWriter = (function (this__5330__auto__,writer__5331__auto__,opt__5332__auto__){
return cljs.core._write(writer__5331__auto__,"reagent.impl.template/t_reagent$impl$template37809");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template37809.
 */
reagent.impl.template.__GT_t_reagent$impl$template37809 = (function reagent$impl$template$__GT_t_reagent$impl$template37809(opts,id,fn_to_element,parse_fn,meta37810){
return (new reagent.impl.template.t_reagent$impl$template37809(opts,id,fn_to_element,parse_fn,meta37810));
});
...
return (new reagent.impl.template.t_reagent$impl$template37809(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
