...
var on_change = (function (p1__40168_SHARP_){
return re_frame.core.dispatch(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("openllm.components.side-bar.model-params.events","set-model-config-parameter","openllm.components.side-bar.model-params.events/set-model-config-parameter",1676339857),id,p1__40168_SHARP_.target.value], null));
});
...
var on_change = (function (p1__40169_SHARP_){
return re_frame.core.dispatch(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("openllm.components.side-bar.model-params.events","set-model-config-parameter","openllm.components.side-bar.model-params.events/set-model-config-parameter",1676339857),id,p1__40169_SHARP_.target.value], null));
});
var num_type_QMARK_ = cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(cljs.core.int_QMARK_,cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(openllm.components.side_bar.model_params.db.parameter_meta_data,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [id,new cljs.core.Keyword(null,"type-pred","type-pred",670733862)], null)));
 ...
 */
openllm.components.side_bar.model_params.views.parameter_list_entry = (function openllm$components$side_bar$model_params$views$parameter_list_entry(p__40171){
var vec__40172 = p__40171;
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40172,(0),null);
...
var value = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40175__$1,new cljs.core.Keyword(null,"value","value",305978217));
var name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40175__$1,new cljs.core.Keyword(null,"name","name",1843675177));
...
if(cljs.core.truth_((pred__40176.cljs$core$IFn$_invoke$arity$2 ? pred__40176.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"binary","binary",-1802232288),expr__40177) : pred__40176.call(null,new cljs.core.Keyword(null,"binary","binary",-1802232288),expr__40177)))){
...
if(cljs.core.truth_((pred__40176.cljs$core$IFn$_invoke$arity$2 ? pred__40176.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"field","field",-1302436500),expr__40177) : pred__40176.call(null,new cljs.core.Keyword(null,"field","field",-1302436500),expr__40177)))){
...
return (function (){
var basic_params = cljs.core.filterv((function (p__40179){
var vec__40180 = p__40179;
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40180,(0),null);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40180,(1),null);
...
var advanced_params = cljs.core.filterv((function (p__40183){
var vec__40184 = p__40183;
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40184,(0),null);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40184,(1),null);
