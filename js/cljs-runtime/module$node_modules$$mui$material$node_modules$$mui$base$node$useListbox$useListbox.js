...
key):null;desc&&(desc.get||desc.set)?Object.defineProperty(newObj,key,desc):newObj[key]=obj[key]}newObj.default=obj;nodeInterop&&nodeInterop.set(obj,newObj);return newObj}(require("module$node_modules$react$index")),_utils=require("module$node_modules$$mui$utils$index"),_useListbox=require("module$node_modules$$mui$material$node_modules$$mui$base$node$useListbox$useListbox_types"),_defaultListboxReducer=global(require("module$node_modules$$mui$material$node_modules$$mui$base$node$useListbox$defaultListboxReducer")),
_useControllableReducer=global(require("module$node_modules$$mui$material$node_modules$$mui$base$node$useListbox$useControllableReducer")),_areArraysEqual=global(require("module$node_modules$$mui$material$node_modules$$mui$base$node$utils$areArraysEqual")),_useLatest=global(require("module$node_modules$$mui$material$node_modules$$mui$base$node$utils$useLatest")),_useTextNavigation=global(require("module$node_modules$$mui$material$node_modules$$mui$base$node$utils$useTextNavigation"));const defaultOptionComparer=
(optionA,optionB)=>optionA===optionB,defaultIsOptionDisabled=()=>!1,defaultOptionStringifier=option=>"string"===typeof option?option:String(option)}
//# sourceMappingURL=module$node_modules$$mui$material$node_modules$$mui$base$node$useListbox$useListbox.js.map
