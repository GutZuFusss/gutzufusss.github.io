...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$3(new cljs.core.Keyword("openllm.components.chat.events","set-chat-input-value","openllm.components.chat.events/set-chat-input-value",990254050),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [openllm.events.check_spec_interceptor], null),(function (db,p__32648){
var vec__32649 = p__32648;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32649,(0),null);
var new_value = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32649,(1),null);
...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$3(new cljs.core.Keyword("openllm.components.chat.events","add-to-app-db-history","openllm.components.chat.events/add-to-app-db-history",-634158144),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [openllm.events.check_spec_interceptor], null),(function (db,p__32657){
var vec__32661 = p__32657;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32661,(0),null);
var timestamp = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32661,(1),null);
var user = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32661,(2),null);
var text = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32661,(3),null);
...
re_frame.core.reg_event_fx.cljs$core$IFn$_invoke$arity$3(new cljs.core.Keyword("openllm.components.chat.events","add-to-chat-history","openllm.components.chat.events/add-to-chat-history",-176125614),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [re_frame.core.inject_cofx.cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"time-now","time-now",-206239031))], null),(function (cofx,p__32674){
var vec__32676 = p__32674;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32676,(0),null);
var user = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32676,(1),null);
var text = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32676,(2),null);
var map__32684 = cofx;
var map__32684__$1 = cljs.core.__destructure_map(map__32684);
var time_now = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__32684__$1,new cljs.core.Keyword(null,"time-now","time-now",-206239031));
...
re_frame.core.reg_event_fx.cljs$core$IFn$_invoke$arity$3(new cljs.core.Keyword("openllm.components.chat.events","send-prompt-success","openllm.components.chat.events/send-prompt-success",-1055704007),cljs.core.PersistentVector.EMPTY,(function (_,p__32685){
var vec__32686 = p__32685;
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32686,(0),null);
var response = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32686,(1),null);
...
re_frame.core.reg_event_fx.cljs$core$IFn$_invoke$arity$3(new cljs.core.Keyword("openllm.components.chat.events","send-prompt-failure","openllm.components.chat.events/send-prompt-failure",-1094313335),cljs.core.PersistentVector.EMPTY,(function (_,p__32693){
var vec__32694 = p__32693;
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32694,(0),null);
...
re_frame.core.reg_event_fx.cljs$core$IFn$_invoke$arity$3(new cljs.core.Keyword("openllm.components.chat.events","on-send-button-click","openllm.components.chat.events/on-send-button-click",-708855792),cljs.core.PersistentVector.EMPTY,(function (p__32701,p__32702){
var map__32703 = p__32701;
var map__32703__$1 = cljs.core.__destructure_map(map__32703);
var db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__32703__$1,new cljs.core.Keyword(null,"db","db",993250759));
var vec__32704 = p__32702;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32704,(0),null);
var prompt = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32704,(1),null);
var llm_config = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32704,(2),null);
...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$3(new cljs.core.Keyword("openllm.components.chat.events","toggle-modal","openllm.components.chat.events/toggle-modal",-1388708298),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [openllm.events.check_spec_interceptor], null),(function (db,p__32707){
...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$3(new cljs.core.Keyword("openllm.components.chat.events","set-prompt-layout","openllm.components.chat.events/set-prompt-layout",-1573538316),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [openllm.events.check_spec_interceptor], null),(function (db,p__32711){
var vec__32712 = p__32711;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32712,(0),null);
var layout = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32712,(1),null);
