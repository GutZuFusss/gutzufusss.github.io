...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$3(new cljs.core.Keyword("openllm.components.chat.events","set-chat-input-value","openllm.components.chat.events/set-chat-input-value",990254050),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [openllm.events.check_spec_interceptor], null),(function (db,p__29095){
var vec__29096 = p__29095;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29096,(0),null);
var new_value = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29096,(1),null);
...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$3(new cljs.core.Keyword("openllm.components.chat.events","add-to-app-db-history","openllm.components.chat.events/add-to-app-db-history",-634158144),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [openllm.events.check_spec_interceptor], null),(function (db,p__29107){
var vec__29108 = p__29107;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29108,(0),null);
var timestamp = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29108,(1),null);
var user = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29108,(2),null);
var text = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29108,(3),null);
...
re_frame.core.reg_event_fx.cljs$core$IFn$_invoke$arity$3(new cljs.core.Keyword("openllm.components.chat.events","add-to-chat-history","openllm.components.chat.events/add-to-chat-history",-176125614),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [re_frame.core.inject_cofx.cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"time-now","time-now",-206239031))], null),(function (cofx,p__29121){
var vec__29126 = p__29121;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29126,(0),null);
var user = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29126,(1),null);
var text = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29126,(2),null);
var map__29131 = cofx;
var map__29131__$1 = cljs.core.__destructure_map(map__29131);
var time_now = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29131__$1,new cljs.core.Keyword(null,"time-now","time-now",-206239031));
...
re_frame.core.reg_event_fx.cljs$core$IFn$_invoke$arity$3(new cljs.core.Keyword("openllm.components.chat.events","send-prompt-success","openllm.components.chat.events/send-prompt-success",-1055704007),cljs.core.PersistentVector.EMPTY,(function (_,p__29132){
var vec__29133 = p__29132;
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29133,(0),null);
var response = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29133,(1),null);
...
re_frame.core.reg_event_fx.cljs$core$IFn$_invoke$arity$3(new cljs.core.Keyword("openllm.components.chat.events","send-prompt-failure","openllm.components.chat.events/send-prompt-failure",-1094313335),cljs.core.PersistentVector.EMPTY,(function (_,p__29140){
...
re_frame.core.reg_event_fx.cljs$core$IFn$_invoke$arity$3(new cljs.core.Keyword("openllm.components.chat.events","on-send-button-click","openllm.components.chat.events/on-send-button-click",-708855792),cljs.core.PersistentVector.EMPTY,(function (p__29148,p__29149){
var map__29150 = p__29148;
var map__29150__$1 = cljs.core.__destructure_map(map__29150);
var db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29150__$1,new cljs.core.Keyword(null,"db","db",993250759));
var vec__29151 = p__29149;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29151,(0),null);
var prompt = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29151,(1),null);
var llm_config = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29151,(2),null);
...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$3(new cljs.core.Keyword("openllm.components.chat.events","toggle-modal","openllm.components.chat.events/toggle-modal",-1388708298),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [openllm.events.check_spec_interceptor], null),(function (db,p__29154){
var vec__29155 = p__29154;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29155,(0),null);
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29155,(1),null);
...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$3(new cljs.core.Keyword("openllm.components.chat.events","set-prompt-layout","openllm.components.chat.events/set-prompt-layout",-1573538316),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [openllm.events.check_spec_interceptor], null),(function (db,p__29158){
var vec__29159 = p__29158;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29159,(0),null);
var layout = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29159,(1),null);
