...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$3(new cljs.core.Keyword("openllm.components.chat.events","set-chat-input-value","openllm.components.chat.events/set-chat-input-value",990254050),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [openllm.events.check_spec_interceptor], null),(function (db,p__39847){
var vec__39848 = p__39847;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39848,(0),null);
var new_value = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39848,(1),null);
...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$3(new cljs.core.Keyword("openllm.components.chat.events","add-to-app-db-history","openllm.components.chat.events/add-to-app-db-history",-634158144),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [openllm.events.check_spec_interceptor], null),(function (db,p__39851){
var vec__39852 = p__39851;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39852,(0),null);
var timestamp = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39852,(1),null);
var user = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39852,(2),null);
var text = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39852,(3),null);
...
re_frame.core.reg_event_fx.cljs$core$IFn$_invoke$arity$3(new cljs.core.Keyword("openllm.components.chat.events","add-to-chat-history","openllm.components.chat.events/add-to-chat-history",-176125614),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [re_frame.core.inject_cofx.cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"time-now","time-now",-206239031))], null),(function (cofx,p__39857){
var vec__39858 = p__39857;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39858,(0),null);
var user = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39858,(1),null);
var text = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39858,(2),null);
var map__39861 = cofx;
var map__39861__$1 = cljs.core.__destructure_map(map__39861);
var time_now = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__39861__$1,new cljs.core.Keyword(null,"time-now","time-now",-206239031));
...
re_frame.core.reg_event_fx.cljs$core$IFn$_invoke$arity$3(new cljs.core.Keyword("openllm.components.chat.events","send-prompt-success","openllm.components.chat.events/send-prompt-success",-1055704007),cljs.core.PersistentVector.EMPTY,(function (_,p__39862){
var vec__39863 = p__39862;
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39863,(0),null);
var response = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39863,(1),null);
...
re_frame.core.reg_event_fx.cljs$core$IFn$_invoke$arity$3(new cljs.core.Keyword("openllm.components.chat.events","send-prompt-failure","openllm.components.chat.events/send-prompt-failure",-1094313335),cljs.core.PersistentVector.EMPTY,(function (_,p__39868){
var vec__39869 = p__39868;
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39869,(0),null);
var e = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39869,(1),null);
...
re_frame.core.reg_event_fx.cljs$core$IFn$_invoke$arity$3(new cljs.core.Keyword("openllm.components.chat.events","on-send-button-click","openllm.components.chat.events/on-send-button-click",-708855792),cljs.core.PersistentVector.EMPTY,(function (p__39872,p__39873){
var map__39874 = p__39872;
var map__39874__$1 = cljs.core.__destructure_map(map__39874);
var db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__39874__$1,new cljs.core.Keyword(null,"db","db",993250759));
var vec__39875 = p__39873;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39875,(0),null);
var prompt = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39875,(1),null);
var llm_config = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39875,(2),null);
...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$3(new cljs.core.Keyword("openllm.components.chat.events","toggle-modal","openllm.components.chat.events/toggle-modal",-1388708298),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [openllm.events.check_spec_interceptor], null),(function (db,p__39880){
var vec__39881 = p__39880;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39881,(0),null);
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39881,(1),null);
...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$3(new cljs.core.Keyword("openllm.components.chat.events","set-prompt-layout","openllm.components.chat.events/set-prompt-layout",-1573538316),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [openllm.events.check_spec_interceptor], null),(function (db,p__39884){
var vec__39885 = p__39884;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39885,(0),null);
var layout = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39885,(1),null);
