...
state,{highlightedValue:action.highlight});case _useListbox.ActionTypes.textNavigation:return handleTextNavigation(state,action.searchString,action.props);case _useListbox.ActionTypes.optionsChange:return handleOptionsChange(action.options,action.previousOptions,state,action.props);default:return state}};var _extends2=global(require("module$node_modules$$babel$runtime$helpers$extends")),_useListbox=require("module$node_modules$$mui$material$node_modules$$mui$base$node$useListbox$useListbox_types");
const textCriteriaMatches=(nextFocus,searchString,stringifyOption)=>{var _stringifyOption;return(nextFocus=null==(_stringifyOption=stringifyOption(nextFocus))?void 0:_stringifyOption.trim().toLowerCase())&&0!==nextFocus.length?0===nextFocus.indexOf(searchString):!1}}
//# sourceMappingURL=module$node_modules$$mui$material$node_modules$$mui$base$node$useListbox$defaultListboxReducer.js.map
