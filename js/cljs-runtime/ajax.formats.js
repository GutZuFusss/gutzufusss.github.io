...
var G__39839 = request;
var G__39840 = cljs.core.second(format_entry);
return (ajax.formats.get_format.cljs$core$IFn$_invoke$arity$2 ? ajax.formats.get_format.cljs$core$IFn$_invoke$arity$2(G__39839,G__39840) : ajax.formats.get_format.call(null,G__39839,G__39840));
} else {
...
return cljs.core.some((function (p1__39845_SHARP_){
return ajax.formats.content_type_matches(content_type,p1__39845_SHARP_);
}),accept);
});
ajax.formats.get_default_format = (function ajax$formats$get_default_format(response,p__39848){
var map__39849 = p__39848;
var map__39849__$1 = cljs.core.__destructure_map(map__39849);
var request = map__39849__$1;
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__39849__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
...
var fexpr__39851 = new cljs.core.Keyword(null,"read","read",1140058661).cljs$core$IFn$_invoke$arity$1(format);
return (fexpr__39851.cljs$core$IFn$_invoke$arity$1 ? fexpr__39851.cljs$core$IFn$_invoke$arity$1(response) : fexpr__39851.call(null,response));
});
});
ajax.formats.accept_header = (function ajax$formats$accept_header(p__39853){
var map__39854 = p__39853;
var map__39854__$1 = cljs.core.__destructure_map(map__39854);
var request = map__39854__$1;
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__39854__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
...
return cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic((function (p1__39852_SHARP_){
return ajax.formats.get_accept_entries(request,p1__39852_SHARP_);
