...
return [(function (){var pred__38071 = cljs.core.instance_QMARK_;
var expr__38072 = reactive_val;
if(cljs.core.truth_((pred__38071.cljs$core$IFn$_invoke$arity$2 ? pred__38071.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RAtom,expr__38072) : pred__38071.call(null,reagent.ratom.RAtom,expr__38072)))){
return "ra";
} else {
if(cljs.core.truth_((pred__38071.cljs$core$IFn$_invoke$arity$2 ? pred__38071.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RCursor,expr__38072) : pred__38071.call(null,reagent.ratom.RCursor,expr__38072)))){
return "rc";
} else {
if(cljs.core.truth_((pred__38071.cljs$core$IFn$_invoke$arity$2 ? pred__38071.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Reaction,expr__38072) : pred__38071.call(null,reagent.ratom.Reaction,expr__38072)))){
return "rx";
} else {
if(cljs.core.truth_((pred__38071.cljs$core$IFn$_invoke$arity$2 ? pred__38071.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Track,expr__38072) : pred__38071.call(null,reagent.ratom.Track,expr__38072)))){
return "tr";
} else {
return "other";
}
