...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$3(new cljs.core.Keyword("openllm.components.playground.events","set-prompt-input","openllm.components.playground.events/set-prompt-input",-1413458575),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [openllm.events.check_spec_interceptor], null),(function (db,p__29091){
var vec__29092 = p__29091;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29092,(0),null);
var value = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29092,(1),null);
...
re_frame.core.reg_event_fx.cljs$core$IFn$_invoke$arity$3(new cljs.core.Keyword("openllm.components.playground.events","send-prompt-success","openllm.components.playground.events/send-prompt-success",-653271490),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [openllm.events.check_spec_interceptor], null),(function (db,p__29099){
var vec__29100 = p__29099;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29100,(0),null);
var response = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29100,(1),null);
...
re_frame.core.reg_event_fx.cljs$core$IFn$_invoke$arity$3(new cljs.core.Keyword("openllm.components.playground.events","send-prompt-failure","openllm.components.playground.events/send-prompt-failure",-1228778344),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [openllm.events.check_spec_interceptor], null),(function (p__29111,p__29112){
var map__29113 = p__29111;
var map__29113__$1 = cljs.core.__destructure_map(map__29113);
var db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29113__$1,new cljs.core.Keyword(null,"db","db",993250759));
var vec__29114 = p__29112;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29114,(0),null);
var e = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29114,(1),null);
...
re_frame.core.reg_event_fx.cljs$core$IFn$_invoke$arity$3(new cljs.core.Keyword("openllm.components.playground.events","on-send-button-click","openllm.components.playground.events/on-send-button-click",-1111011821),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [openllm.events.check_spec_interceptor], null),(function (_,p__29122){
var vec__29123 = p__29122;
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29123,(0),null);
var prompt = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29123,(1),null);
var llm_config = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29123,(2),null);
